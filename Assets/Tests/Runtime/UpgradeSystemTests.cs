...
namespace NeonLadder.Tests.Runtime
{
    ...
    public class UpgradeSystemTests
    {
        ...
        private List<UpgradeData> testUpgrades;
        ...
        public void SetUp()
        {
            ...
            // Create test upgrade system
            var upgradeSystemComponent = testPlayerObject.AddComponent<UpgradeSystem>();
            upgradeSystem = upgradeSystemComponent;
            
            // Create test upgrades
            CreateTestUpgrades();
            
            // Set up the upgrade system with test data
            SetupUpgradeSystemWithTestData(upgradeSystemComponent);
        }
        ...
        {
            testUpgrades = new List<UpgradeData>
            {
        ...
        private UpgradeData CreateTestUpgrade(string id, string name, CurrencyType currencyType, int cost, int maxLevel, UpgradeCategory category, string[] prerequisites = null, string[] mutuallyExclusive = null)
        {
            var upgradeData = ScriptableObject.CreateInstance<UpgradeData>();
            
            // Use reflection to set private fields for testing
            var idField = typeof(UpgradeData).GetField("id", System.Reflection.BindingFlags.NonPublic | System.Reflection.BindingFlags.Instance);
            var nameField = typeof(UpgradeData).GetField("upgradeName", System.Reflection.BindingFlags.NonPublic | System.Reflection.BindingFlags.Instance);
            var currencyField = typeof(UpgradeData).GetField("currencyType", System.Reflection.BindingFlags.NonPublic | System.Reflection.BindingFlags.Instance);
            var costField = typeof(UpgradeData).GetField("baseCost", System.Reflection.BindingFlags.NonPublic | System.Reflection.BindingFlags.Instance);
            var maxLevelField = typeof(UpgradeData).GetField("maxLevel", System.Reflection.BindingFlags.NonPublic | System.Reflection.BindingFlags.Instance);
            var categoryField = typeof(UpgradeData).GetField("category", System.Reflection.BindingFlags.NonPublic | System.Reflection.BindingFlags.Instance);
            var prereqField = typeof(UpgradeData).GetField("prerequisites", System.Reflection.BindingFlags.NonPublic | System.Reflection.BindingFlags.Instance);
            var exclusiveField = typeof(UpgradeData).GetField("mutuallyExclusive", System.Reflection.BindingFlags.NonPublic | System.Reflection.BindingFlags.Instance);
            
            idField?.SetValue(upgradeData, id);
            nameField?.SetValue(upgradeData, name);
            currencyField?.SetValue(upgradeData, currencyType);
            costField?.SetValue(upgradeData, cost);
            maxLevelField?.SetValue(upgradeData, maxLevel);
            categoryField?.SetValue(upgradeData, category);
            prereqField?.SetValue(upgradeData, prerequisites ?? new string[0]);
            exclusiveField?.SetValue(upgradeData, mutuallyExclusive ?? new string[0]);
            
            return upgradeData;
        }
        
        private void SetupUpgradeSystemWithTestData(UpgradeSystem upgradeSystemComponent)
        {
            // Use reflection to set the availableUpgrades field
