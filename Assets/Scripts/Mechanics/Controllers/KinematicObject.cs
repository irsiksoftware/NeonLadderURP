...
namespace NeonLadder.Mechanics.Controllers
{
    public class KinematicObject : MonoBehaviour
    {
        ...
        private void CacheAnimationClipLengths()
        {
            ...
            {
                NLDebug.LogWarning($"Animator or RuntimeAnimatorController not found on {gameObject.name}");
                return;
            }
        ...
        private float GetAnimationClipLength(Animations animation)
        {
            ...
            NLDebug.LogWarning($"Animation {animation} not found or animation clips not cached");
            return 0f;
        }
        ...
        public IEnumerator PlayGetHitAnimation(bool stopEarly = false)
        {
            ...
            NLDebug.Log($"animation value: {Animator.GetInteger(animationParamName)}");
