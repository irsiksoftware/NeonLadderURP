...
namespace NeonLadder.Mechanics.Controllers
{
    public abstract class Enemy : KinematicObject
    {
        ...
        [SerializeField]
        protected virtual int attackDamage { get; set; } = Constants.EnemyAttackDamage; // Damage per attack

        public float deathBuffer = Constants.DeathAnimationBuffer;
        ...
        protected virtual float AttackRange
        {
            get
            {
                ...
                else
                {
                    ...
                    return boxCollider != null ? boxCollider.size.x / 2 + Constants.AttackRangeBoxColliderOffset : Constants.DefaultAttackRange; // Default value if no BoxCollider found
                }
            }
        ...
        [SerializeField]
        protected virtual float retreatBuffer { get; set; } = Constants.RetreatBuffer;
        [SerializeField]
        private float _attackCooldown = Constants.AttackCooldown; // Default value if not set in the editor or overridden
